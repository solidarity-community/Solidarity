...
public class CampaignController : ControllerBase
{
	...
	[HttpPost]
	public ActionResult<Campaign> Create([FromBody, Bind(nameof(Campaign.CreatorId), nameof(Campaign.Description), nameof(Campaign.Title), nameof(Campaign.Media))] Campaign campaign)
		=> Ok(_campaignService.Create(campaign));

	[HttpPut("{id}")]
	public ActionResult<Campaign> Update([FromBody, Bind(nameof(Campaign.Id), nameof(Campaign.Description), nameof(Campaign.Title), nameof(Campaign.Media))] Campaign campaign)
